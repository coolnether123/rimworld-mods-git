...
public static class Pawn_ApparelTracker_Patch
{
    ...
    public class TryDrop
    {
        ...
        {
            return AccessTools.Method(typeof(Pawn_ApparelTracker), nameof(Pawn_ApparelTracker.TryDrop), [typeof(Apparel), typeof(Apparel).MakeByRefType(), typeof(IntVec3), typeof(bool)]);
        }
